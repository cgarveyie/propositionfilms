<?php
/**
 * The template for displaying custom slides
 *
 * @package WordPress
 * @subpackage Struck
 * @since Struck 1.0
...
// if there are slides
if( $tw_row['custom-slides'] ) :

    // start with slide number 0
    $slidenumber = 0;

    // each slide
    foreach( $tw_row['custom-slides'] as $slide ) :

        // get slide properties
        $slide_data = tw_get_sections($slidenumber+1, $total_sections, $field_object['value'][$section_count-1]['custom-slides']);

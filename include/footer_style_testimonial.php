		<!-- Complete description of HTML structure for this element is located in file page/style_testimonial.php -->
		<h4 class="template-header-uppercase template-header-underline template-carousel-style-2">Carousel<span></span></h4>
		<div class="template-testimonial template-testimonial-style-2 template-carousel template-carousel-style-2 template-carousel-testimonial">
		...
		<h4 class="template-header-uppercase template-header-underline">Layout 50x50%<span></span></h4>
		...
		<h4 class="template-header-uppercase template-header-underline">Layout 33x33x33%<span></span></h4>
		<div class="template-testimonial template-testimonial-style-2">					
		...
		<h4 class="template-header-uppercase template-header-underline">Layout 25x25x25x25%<span></span></h4>
		<div class="template-testimonial template-testimonial-style-2">				

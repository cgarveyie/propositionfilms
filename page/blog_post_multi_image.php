...
<?php
		Template::_header('Post With Images','Posted on February 24, 2014','5 Comments');
?>
					...
					<div class="template-post">
						...
						<div class="template-post-section-bottom">
							...
							<div class="template-post-section-bottom-left">
								<div class="template-post-box-post-type template-icon-small template-icon-slider"></div>

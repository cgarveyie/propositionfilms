...
<?php
		Template::_header('Portfolio 4 Columns','Our portfolio features a variety of projects and services','Click the image you want to learn about');
?>
			<!-- Complete description of HTML structure for portfolio is located in file portfolio_layout_1_column.php -->
			
			<ul class="template-layout-25x25x25x25 template-reset-list template-clear-fix template-portfolio-list">
				...
				<li class="template-layout-column-left">
					<div class="template-image">
						<a href="media/image/_sample/portfolio_960x832_5.jpg" class="template-image-box-top template-image-preloader" data-fancybox-group="gallery">
				...
				<li class="template-layout-column-center-left">
					<div class="template-image">
						<a href="media/image/_sample/portfolio_960x832_6.jpg" class="template-image-box-top template-image-preloader" data-fancybox-group="gallery">
				...
				<li class="template-layout-column-center-right">
					<div class="template-image">
						<a href="media/image/_sample/portfolio_960x832_7.jpg" class="template-image-box-top template-image-preloader" data-fancybox-group="gallery">
							<img src="media/image/_sample/portfolio_660x572_7.jpg" alt=""/>
						</a>
						<div class="template-image-box-bottom">
							<div class="template-image-box-bottom-title"><a href="<?php $Template->_getURL('portfolio/item'); ?>">Buckeye Furniture</a></div>
							<div class="template-image-box-bottom-subtitle">Website Design &amp; Development</div>
				...
				<li class="template-layout-column-right">
					<div class="template-image">
						<a href="media/image/_sample/portfolio_960x832_8.jpg" class="template-image-box-top template-image-preloader" data-fancybox-group="gallery">
							<img src="media/image/_sample/portfolio_660x572_8.jpg" alt=""/>
						</a>
						<div class="template-image-box-bottom">
							<div class="template-image-box-bottom-title"><a href="<?php $Template->_getURL('portfolio/item'); ?>">Buckeye Furniture</a></div>
							<div class="template-image-box-bottom-subtitle">Website Design &amp; Development</div>
